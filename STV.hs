-- An implementation of the "Single Transferable Vote" system in Haskell.
-- By Luke Halley.
...
-- Defining types to use throughout the code to improve code readability.
type Person = String
type People = [Person]
type Vote = (People, Int)
type Votes = [Vote]

-- Creating the ExitingCandidate typeclass.
...
-- Computes the next recursive step for the, which is either eliminating or electing someone.
